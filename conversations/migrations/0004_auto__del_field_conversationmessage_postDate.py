...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ConversationMessage.postDate'
        db.delete_column(u'conversations_conversationmessage', 'postDate')


    def backwards(self, orm):
        # Adding field 'ConversationMessage.postDate'
        db.add_column(u'conversations_conversationmessage', 'postDate',
