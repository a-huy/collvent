...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'events_event', 'end_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Event.start_date'
        db.alter_column(u'events_event', 'start_date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Event.end_date'
        db.alter_column(u'events_event', 'end_date', self.gf('django.db.models.fields.DateField')(default=''))

        # Changing field 'Event.start_date'
        db.alter_column(u'events_event', 'start_date', self.gf('django.db.models.fields.DateField')(default=''))
